        ...
        foreach ($arResult as $arItem):
            ...
            <div class="footer__feedback">
                <div class="footer__mail">
                    <a href="<?php
                    $APPLICATION->IncludeFile(INCLUDE_PATH . '/html/mailto.php', [],
                        ['SHOW_BORDER' => false, 'MODE' => 'php']);
                    ?>">
                        <?php
                        $APPLICATION->IncludeFile(
                            INCLUDE_PATH . '/html/mail.php',
                            [
                            ],
                            ['MODE' => 'text']);
                        ?></a>
                    ...
                    <a href="">
                        <svg width="40" height="40" viewBox="0 0 53 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0)">
                                <path d="M31.3727 25.7319C31.3727 28.4521 29.1677 30.6571 26.4475 30.6571C23.7273 30.6571 21.5222 28.4521 21.5222 25.7319C21.5222 23.0117 23.7273 20.8066 26.4475 20.8066C29.1677 20.8066 31.3727 23.0117 31.3727 25.7319Z"
                                      fill="white"/>
                    ...
                    <a href="">
                        <svg width="40" height="40" viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0)">
                                ...
                                <path d="M26.1628 0C11.9536 0 0.430908 11.5227 0.430908 25.7319C0.430908 39.941 11.9536 51.4638 26.1628 51.4638C40.3719 51.4638 51.8947 39.941 51.8947 25.7319C51.8947 11.5227 40.3719 0 26.1628 0ZM42.2413 25.7582C42.2413 25.7582 42.2413 30.9767 41.5793 33.4931C41.2083 34.8705 40.1222 35.9566 38.7449 36.3272C36.2284 36.9896 26.1628 36.9896 26.1628 36.9896C26.1628 36.9896 16.1234 36.9896 13.5807 36.3009C12.2034 35.9302 11.1173 34.8438 10.7463 33.4664C10.0839 30.9767 10.0839 25.7319 10.0839 25.7319C10.0839 25.7319 10.0839 20.5137 10.7463 17.9973C11.1169 16.6199 12.2297 15.5072 13.5807 15.1366C16.0971 14.4742 26.1628 14.4742 26.1628 14.4742C26.1628 14.4742 36.2284 14.4742 38.7449 15.1629C40.1222 15.5335 41.2083 16.6199 41.5793 17.9973C42.268 20.5137 42.2413 25.7582 42.2413 25.7582Z"
                                      fill="white"/>
                            </g>
                            <defs>
                                <clipPath id="clip0">
                                    <rect width="51.4638" height="51.4638" fill="white"
                                          transform="translate(0.430908)"/>
                                </clipPath>
                            </defs>
                        </svg>
                    </a>
